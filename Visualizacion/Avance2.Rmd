...
```{r grafica 1 JJ}
valores_frame <- c(vueCant,angularCant,flutterCant)
datospr3 <- data.frame("framework" = c("Vue","Angular","Flutter"),
                       "valor" = valores_frame)
